...
function bleachwave_add_styles() {
	wp_enqueue_style( 'fonts', 'http://fonts.googleapis.com/css?family=IM+Fell+English+SC|Oswald', false,null );
...
// Convert p tags around iframes to div tags
function filter_ptags_on_iframes($content) {
  return preg_replace('/<p>\s*(<iframe .*>*.<\/iframe>)\s*<\/p>/iU', '<div class="iframe-wrap">$1</div>', $content);
}
